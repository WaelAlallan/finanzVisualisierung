...
import com.autoanalytics.finanzVisualisierung.storage.StorageException;
...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    @Override
    public void init() {
        //TODO erstmal prüfen ob Folder "upload" existiert, wenn nicht dann einen erstellen
        try {
            Files.createDirectories(rootLocation);
        }
        catch (IOException e) {
            throw new StorageException("Could not initialize folder to save uploads!", e);
        }
    }
